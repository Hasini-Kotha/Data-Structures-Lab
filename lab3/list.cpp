    ...
    while(choice!= 10){
     ...
     switch(choice){
      ...
      case 2 :
       ...
       scanf("%d",&value);
       printf("Enter at which index you wann insert \n");
       scanf("%d",&index);
       ...
       scanf("%d",&target);
       list1.search(target);
       printf("The searched element is in the index of %d",list1.search(target));
       list1.display();
       break;
       case 9 :
